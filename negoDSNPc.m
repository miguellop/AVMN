...
%experimenttypestr = 'random2';
%experimenttypestr = 'random3';

% if strcmp(experimenttypestr, 'random')
%     load UFRandom;
% elseif strcmp(experimenttypestr, 'random1')
%     load UFRandom1;
% elseif strcmp(experimenttypestr, 'random2')
%     load UFRandom2;
% elseif strcmp(experimenttypestr, 'random3')
%     load UFRandom3;
% else
%     load UFfix
% end
